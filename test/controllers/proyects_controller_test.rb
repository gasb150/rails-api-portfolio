...
class ProyectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create proyect' do
    assert_difference('Proyect.count') do
      post proyects_url,
           params: { proyect: { framework_id: @proyect.framework_id, imageurl: @proyect.imageurl,
                                language_id: @proyect.language_id, live_url: @proyect.live_url,
                                name: @proyect.name, other: @proyect.other,
                                skill_id: @proyect.skill_id, source_url: @proyect.source_url } }
    end
